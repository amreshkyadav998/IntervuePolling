    ...
    <div className="w-full md:w-[80%] lg:w-[60%] h-auto min-h-[80vh] p-4">
      ...
      {!questionPublished ? (
        <div className="bg-white rounded-lg shadow-lg p-6">
          <div className="mb-4">
            <div className="inline-flex bg-purple-500 text-white text-xs font-semibold py-1 px-2 rounded-full mb-2">
              <svg
                width="16"
                height="15"
                viewBox="0 0 16 15"
          ...
          {options.length < 6 && (
            <button
              onClick={addOption}
              className="text-purple-600 border border-purple-600 rounded-md px-3 py-2 text-sm font-medium mb-4 hover:bg-purple-50"
            >
              + Add More option
            </button>
          )}
          ...
          <div className="flex flex-col md:flex-row justify-between items-center mt-4 gap-4">
            <div className="flex items-center w-full md:w-auto">
              ...
              <div className="relative w-36">
                <input
                  className="border border-gray-300 rounded-md bg-white p-2 pr-8 text-gray-800 focus:outline-none focus:ring-2 focus:ring-purple-500 w-full"
                  type="number"
                  min="5"
                  max="300"
                  value={timer}
                  onChange={(e) =>
                    setTimer(Math.max(5, Math.min(300, Number(e.target.value))))
                  }
                />
            ...
            <Button
              className="bg-purple-600 hover:bg-purple-700 text-white font-medium py-2 px-8 rounded-md w-full md:w-auto"
              variant="primary"
              onClick={askQuestion}
            >
              Ask Question
